...
if (localStorage.comments) {
    ...
    initialState = [{ id: 0, author: 'Valery', dateTime: 1516648073108, text: 'initial test comments' }, { id: 1, author: 'Sergey', dateTime: 1516648075308, text: 'initial test comment2' }, { id: 2, author: 'Alex', dateTime: 1516648079708, text: 'initial test comment3' }];
}
...
var _addComment2 = __webpack_require__(70);

var _addComment3 = _interopRequireDefault(_addComment2);

var _actions = __webpack_require__(71);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var CommentsApp = function CommentsApp(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_comments2.default, { comments: comments, deleteComment: deleteComment }),
        _react2.default.createElement(_addComment3.default, { addComment: addComment, nextID: nextID })
    );
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        ...
        addComment: function addComment(author, text, nextID) {
            return dispatch((0, _actions.addComment)(author, text, nextID));
        }
    };
};

CommentsApp = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CommentsApp);
...
var AddComment = function AddComment(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement("input", { id: "author", type: "text" })
        ),
        _react2.default.createElement("br", null),
        _react2.default.createElement(
            "label",
            ...
            "\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439:",
            _react2.default.createElement("br", null),
            _react2.default.createElement("textarea", { id: "text", rows: "4", cols: "50" })
        ),
        _react2.default.createElement("br", null),
        _react2.default.createElement(
            "button",
...
var addComment = exports.addComment = function addComment(author, text, nextID) {
    return {
        type: 'ADD_COMMENT',
        id: nextID,
        author: author,
...
var comments = function comments() {
    ...
    switch (action.type) {
        case 'DELETE_COMMENT':
            newState = state.filter(function (comment) {
        ...
        case 'ADD_COMMENT':
            newState = [].concat(_toConsumableArray(state), [{ id: action.id, author: action.author, dateTime: new Date().getTime(), text: action.text }]);
            localStorage.comments = JSON.stringify(newState);
            return newState;
